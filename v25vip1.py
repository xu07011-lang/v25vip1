        ...
        try:
            ...
            if latest_issue_id != session_state["last_known_issue_id"]:
                ...
                if last_bet and str(last_bet["issue_id"]) == latest_issue_id:
                    ...
                    # TÍNH TỔNG TIỀN CƯỢC CHO BẢNG TÓM TẮT
                    total_bet_for_summary = initial_bet_amount_from_last_round + final_bet_amount_from_last_round
                    ...
                    if is_win:
                        ...
                        # Tính lợi nhuận (tiền nhận về * 0.95) - tiền cược cuối
                        round_profit = (final_balance - balance_before) if final_balance is not None and balance_before is not None else (initial_bet_amount_from_last_round * 0.95) - final_bet_amount_from_last_round
                    else: # THUA
                        ...
                        round_profit = -(initial_bet_amount_from_last_round + final_bet_amount_from_last_round)
                ...
                # --- CƯỢC LẦN 2: 50/50 CHỜ VÀ ĐỔI CƯỢC ---
                ...
                # SỬA ĐỔI: Thêm quyết định ngẫu nhiên 50/50
                ...
                if change_bet_response and change_bet_response.get("code") == 0:
                    ...
                    console.print(f"❌ [bold red]Cược cuối cùng thất bại! Cược có thể vẫn ở phòng {initial_room}. Phản hồi: {change_bet_response}[/bold red]")
